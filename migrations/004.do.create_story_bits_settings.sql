...
INSERT INTO settings (name, story_id, is_residence, decor, description)
VALUES
    (
        'The coffeeshop',
        2,
        'true',
        'Cozy. Local art hangs on the walls',
    ...
    (
        ...
        'true',
        'Regal',
        'A place for parties. Has a living space apparently.'
    ),
    (
        'The train',
        4,
        ...
        'A normal train. Has a food car, sleeper cars, and lots of passenger cars'
    ),
    (
        ...
        'The house is in a good neighborhood.'
    ),
    (
        'Villain''s house',
        6,
    ...
    (
        ...
        'It sits up on the hill of the city'
    ),
    (
        'Friend''s house',
        9,
        ...
        'The person who lives here has lived here for 15 years'
    ),
    (
        'Friend''s house',
        10,
    ...
    (
        ...
        'It sits really far off the road'
    ),
    (
        'Mom''s house',
        12,
        ...
        'A comfortable place with a weird feeling because things are a little different.'
    ),
    (
        'Dad''s house',
        13,
    ...
    (
        ...
        'There are so many plants outside that you can barely see it from the road'
    );